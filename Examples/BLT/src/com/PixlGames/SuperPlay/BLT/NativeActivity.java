 ...
 */
package com.PixlGames.SuperPlay.BLT;
 ...
 * library, 'libBLTAndroid.so', and provides access to the
 * exposed C functions.
...
public class NativeActivity extends Activity
{
	 ...
	 * <code>Java_com_PixlGames_SuperPlay_BLT_NativeActivity_nativeactivityNative</code>
	 * for the implementation.
	 */
	public native void nativeactivityNative();

	/* This is the static constructor used to load the
	 * 'BLTAndroid' library when the class is
	 * loaded.
	 */
	static {
		System.loadLibrary("BLTAndroid");
	}
}
