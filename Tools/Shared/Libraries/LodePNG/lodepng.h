...
unsigned LodePNG_decode(unsigned char** out, unsigned* w, unsigned* h, const unsigned char* in, size_t insize, unsigned colorType, unsigned bitDepth,
	unsigned char* palette = NULL, int* paletteCount = NULL); /*return value is error*/
...
unsigned LodePNG_decode_file(unsigned char** out, unsigned* w, unsigned* h, const char* filename, unsigned colorType, unsigned bitDepth,
	unsigned char* palette = NULL, int* paletteCount = NULL);
...
Return value: LodePNG error code (0 means no error).
*/
unsigned LodePNG_encode(unsigned char** out, size_t* outsize, const unsigned char* image, unsigned w, unsigned h, unsigned colorType, unsigned bitDepth, const unsigned char* palette = NULL, int palettecount = 0); /*return value is error*/
...
Return value: LodePNG error code (0 means no error).
*/
unsigned LodePNG_encode_file(const char* filename, const unsigned char* image, unsigned w, unsigned h, unsigned colorType, unsigned bitDepth, const unsigned char* palette = NULL, int palettecount = 0);
