...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch)../Include $(IncludeSwitch)../../Include $(IncludeSwitch)../../DisplayLib/Include $(IncludeSwitch)../../SoundLib/Include $(IncludeSwitch)../../SuperPlayLib/Engine 
IncludePCH             := 
RcIncludePath          := 
Libs                   := 
ArLibs                 :=  
